        ...
        switch ($ruleName) {
            ...
            case 'min':
                if (strlen($value) < $ruleValue) {
                    return "Поле \"$key\" должно быть не менее $ruleValue символов";
                }
                break;
            case 'max':
                if (strlen($value) > $ruleValue) {
                    return "Поле \"$key\" должно быть не более $ruleValue символов";
                }
                break;
            case 'email':
                if (! filter_var($value, FILTER_VALIDATE_EMAIL)) {
                    return "Поле \"$key\" должно быть верным email";
                }
                break;
            case 'confirmed':
